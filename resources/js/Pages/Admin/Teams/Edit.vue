<template>
    <Head title="Edit Team - Admin | SBA" />
    <AdminLayout>
        <div class="edit-page">
            <!-- Header -->
            <div class="header">
                ...
                <form @submit.prevent="submit" class="form">
                    ...
                    <div class="form-group">
                        ...
                        <div class="photo-upload-area">
                            <div v-if="currentLogo" class="photo-preview">
                                <img
                                    :src="currentLogo"
                                    alt="Team logo"
                                    class="preview-image"
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input
                                ...
                                min="0"
                            />
                            <span v-if="form.errors.wins" class="form-error">{{
                                form.errors.wins
                            }}</span>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            />
                            <span
                                v-if="form.errors.losses"
                                class="form-error"
                                >{{ form.errors.losses }}</span
                            >
                        </div>
...
const form = useForm({
    ...
    logo: null,
    remove_logo: false,
    wins: props.team.wins || 0,
    losses: props.team.losses || 0,
    points: props.team.points || 0,
});
...
const currentLogo = computed(() => {
    ...
    if (props.team.logo) {
        const logoPath = props.team.logo;
