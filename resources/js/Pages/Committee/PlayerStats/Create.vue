<template>
    <Head title="Add Player Stats - Committee | SBA" />
    <CommitteeLayout>
        <div class="create-stats-page">
            <!-- Header -->
            <div class="header">
                <Link
                ...
                <h1 class="page-title">Add Player Stats</h1>
            ...
            <div class="glass-card">
                <form @submit.prevent="submit">
                    ...
                    <div class="form-group">
                        ...
                        <span v-if="form.errors.player_id" class="error-text">{{
                    ...
                    <div class="form-actions">
                        ...
                        >
                            {{ form.processing ? "Saving..." : "Add Stats" }}
                        </button>
                    </div>
                </form>
            </div>
...
const submit = () => {
    form.post(route("committee.player-stats.store", props.match.id));
};
</script>
